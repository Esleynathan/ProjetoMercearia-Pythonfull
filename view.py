...
criarArquivos("categoria.txt", "clientes.txt", "estoque.txt", "fornecedores.txt", "funcionarios.txt", "vendas.txt")
        ...
        if local == 1:
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    novaCategoria = input("Digite a categoria para qual deseja remover\n")
            ...
            while True:
                decidir = int(input("Digite 1 para cadastrar um produto\n"
                        "Digite 2 para remover um protudo\n"
                        "Digite 3 para alterar um protudo\n"
                        "Digite 4 para mostrar aos protudo cadastrados\n"
                        "Digite 5 para sair\n"))
